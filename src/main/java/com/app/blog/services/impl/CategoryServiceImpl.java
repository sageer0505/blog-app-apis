...
public class CategoryServiceImpl implements CategoryService {
	...
	public List<CategoryDto> getCategories() {
		List<Category> categries = this.categoryRepo.findAll();
		List<CategoryDto> catDtos = categries.stream().map((cat) ->this.modelMapper.map(cat, CategoryDto.class)).collect(Collectors.toList());
		return catDtos;
	}
